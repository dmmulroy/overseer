...
This directory is Overseer's public HTTP boundary. It authenticates requests, parses protocol input, invokes application services, and returns API data or safe RFC 9457 errors. It also contains the outbound Workspace Registry Durable Object adapter.
...
- `api-response.ts` owns media negotiation, strong ETags, HEAD, and 304 responses.

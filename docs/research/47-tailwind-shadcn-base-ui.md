...
| Dependency surface   | Pay for selected generated components and their declared packages. Base UI is tree-shakable by component. ([Base UI quick start](https://base-ui.com/react/overview/quick-start.md#install-the-library))    | The package declares Base UI plus Shiki, Motion, D3 Geo, react-day-picker, and related dependencies for its wider component set; actual bundle impact still depends on imports and bundling. ([Kumo metadata](https://registry.npmjs.org/@cloudflare/kumo/latest))                                                                                                               |

...
- Cloudflare Access authenticates the human and independently credentialed Agents;
...
| --------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| Cloudflare Access                 | Admission policy and credential lifecycle                                                                                                                                                                                   | Human Allow policy, one Service Auth credential per Agent, application audience                                                                                                                                                                                | Public hostname                                            | Establishes that a request passed Access, but the Gateway still validates the Access JWT, issuer, audience, signature, time, and identity claims.   |
...
3. For an unsafe human request, the Gateway checks the exact configured Origin. For an Agent mutation, it parses the required `Overseer-Session-Id` and optional `Overseer-Harness`.

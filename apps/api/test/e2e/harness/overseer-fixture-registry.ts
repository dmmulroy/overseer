...
export interface OverseerFixtureRegistryValues {
...
export interface OverseerFixtureRegistryModels {
...
export interface OverseerFixtureRegistryScenarios {
...
export interface OverseerFixtureRegistry {
  /** Smallest meaningful generated domain values. */
  readonly values: OverseerFixtureRegistryValues;
  /** Valid generated domain structures at useful test-authoring scales. */
  readonly models: OverseerFixtureRegistryModels;
  /** Generated inputs for representative multi-step test situations. */
  readonly scenarios: OverseerFixtureRegistryScenarios;
}
...
export const createOverseerFixtureRegistry = (): OverseerFixtureRegistry => ({
  values: {

...
Throwaway Wayfinder HITL prototype for [issue #41](https://github.com/dmmulroy/overseer/issues/41). It compares three materially different structures using the approved **Crisp** Tailwind CSS v4 theme and application-owned shadcn `base-nova` source on Base UI.
